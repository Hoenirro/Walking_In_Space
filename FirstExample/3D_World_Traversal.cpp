...
void updatePhysics()
{
    ...
    if (moving_forward) movement_direction += forward_vector;
    if (moving_backward) movement_direction -= forward_vector;
    if (moving_left) movement_direction -= side_vector;
    if (moving_right) movement_direction += side_vector;
...
int main(int argc, char** argv)
{
    ...
    glutKeyboardUpFunc(keyboardUp);  // Add this line
    glutIdleFunc(idle);
